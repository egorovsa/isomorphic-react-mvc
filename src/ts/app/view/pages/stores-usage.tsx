    ...
    public render() {
        return (
            <div className="page-content">
                ...
                <div className="list-item">The framework uses <a
                    href="https://www.npmjs.com/package/react-stores">React-stores</a>. Please use documentation of this
                    module
                </div>
                ...
                <SyntaxHighlighter language="typescript jsx" style={vs2015}>
                    {
