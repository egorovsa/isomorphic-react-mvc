...
export class AppRouter {
    ...
    public findControllerViewComponent(controller: Controller, name: string, actionName: string): void {
        if (!controller.component) {
            ...
            const notFoundData = {
                ...
                viewPath: '../app/view/' + name + '/' + this.camelCaseToDash(actionName) + '.tsx'
            };

            try {
                const component = require('../app/view/' + name + '/' + this.camelCaseToDash(actionName) + '.tsx');
