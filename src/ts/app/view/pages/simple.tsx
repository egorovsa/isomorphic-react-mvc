    ...
    public render() {
        return (
            <div className="page-content">
                ...
                <div className="list-item light">By the way firstParam and secondParam went from the url
                ...
                <div className="list-item light">
                    ...
                    According to our conventions the view file has to has the same name as action with capitalized first
                    letter,<br/>
